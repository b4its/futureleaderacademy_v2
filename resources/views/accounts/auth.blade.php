  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'DM Sans', sans-serif; }
    ...
    .input-wrapper i.fa-user {
      position: absolute; left: 16px; top: 50%; transform: translateY(-50%); color: var(--text-muted); font-size: 18px; 
    }
      ...
      <form id="loginForm" action="{{ route('auth.login') }}" method="POST">
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            ...
            <input type="password" name="password" class="input-field has-toggle" placeholder="••••••••" required>
    ...
    <div id="registerView" class="form-view">
      ...
      <form id="registerForm" action="{{ route('auth.register') }}" method="POST">
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            <i class="fas fa-lock"></i>
            <input type="password" name="password" class="input-field has-toggle" placeholder="Minimal 8 karakter" required>
            <i class="fas fa-eye-slash toggle-password" onclick="togglePassword(this)"></i>
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            <i class="fas fa-lock"></i>
            <input type="password" name="password_confirmation" class="input-field has-toggle" placeholder="Minimal 8 karakter" required>
            <i class="fas fa-eye-slash toggle-password" onclick="togglePassword(this)"></i>
          </div>
        </div>
...
function setRole(role) {
  ...
  if (role === 'panel') {
    ...
    loginDesc.innerHTML = 'Silakan masuk ke Sistem Panel.';
