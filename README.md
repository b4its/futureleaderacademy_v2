...
```bash
docker exec -it flacademyv2-php-fpm bash -c "php artisan config:clear && php artisan view:clear && php artisan cache:clear && php artisan route:clear && php artisan optimize:clear && php artisan optimize"
```
...
```bash
docker exec -it flacademyv2-db mysql -u root
```

### untuk masuk ke terimal container apache
```bash
docker exec -it flacademyv2-php-fpm bash
```

### untuk solo command
```bash
# Jika pakai Nginx
docker exec -it flacademyv2-php-fpm php artisan serve
docker compose exec php-fpm composer install
# untuk melihat log seperti php artisan serve
docker compose logs -f nginx php-fpm
# Jika pakai Apache
docker exec -it flacademyv2-apache php artisan serve
```
...
docker exec -it flacademyv2-php-fpm chown -R www-data:www-data /var/www/html/storage /var/www/html/bootstrap/cache
docker exec -it flacademyv2-php-fpm chmod -R 775 /var/www/html/storage /var/www/html/bootstrap/cache
